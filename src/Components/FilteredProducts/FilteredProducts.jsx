          ...
          <div className="flex flex-wrap justify-center gap-4 py-6 px-3">
            {genderButtons.map((item, index) => (
              <Button
                ...
                variant="outlined"
                color="yellow"
                className="w-full sm:w-auto px-3 py-2 font-bold  text-green-950 shadow-lg bg-white/20 text-lg border-none cursor-pointer transform transition hover:scale-110 duration-300 ease-in-out"
            ...
            <Menu placement="bottom">
              ...
              <MenuList className="min-w-[8rem]">
                {sizeButtons.map((item, index) => (
                  <MenuItem
                    key={index}
                    className="text-[15px] font-semibold border py-1 my-1 hover:cursor-pointer hover:bg-green-950 hover:text-white"
            ...
            <Button
              ...
              variant="outlined"
              color="yellow"
              className="w-full sm:w-auto px-3 py-2 font-bold shadow-lg bg-white/20 text-lg border-none cursor-pointer text-green-950 transform transition hover:scale-110 duration-300 ease-in-out"
